    ...
    override fun onCreateView(
        ...
        btnSignUp.setOnClickListener {
            if (nameUser.toString().trim().isEmpty() ||
                ...
                Toast.makeText(requireContext(), R.string.error_validate_value, Toast.LENGTH_SHORT)
                    .show()
                return@setOnClickListener
            }
            if (passUser.toString().trim() != retryPass.toString().trim()) {
                Toast.makeText(requireContext(), R.string.error_validate_pass, Toast.LENGTH_SHORT)
                    .show()
                return@setOnClickListener
            }
